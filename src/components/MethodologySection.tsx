...
import { Zap, Scale, FlaskConical, ShieldCheck, Target } from "lucide-react";

const MethodologySection = () => {
  return (
    <section className="py-20 bg-muted/30" id="methodology">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <Card className="border-l-4 border-l-blue-500 bg-card/50">
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  O efeito causal médio (ATE<sub>SR</sub>) é a diferença entre o limite da expectativa condicional do resultado (Y) à direita do corte e à esquerda do corte:
                </p>
                <code className="block p-3 bg-muted rounded-md text-sm font-mono overflow-x-auto">
                  ATE<sub>SR</sub> = lim(x→x₀⁺) E(Y|X=x) - lim(x→x₀⁻) E(Y|X=x)
                </code>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-orange-500 bg-card/50">
              ...
              <CardContent className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  O efeito causal médio (ATE<sub>FRD</sub>) é obtido pelo "estimador de Wald", que corrige o cumprimento imperfeito:
                </p>
                <code className="block p-3 bg-muted rounded-md text-sm font-mono overflow-x-auto">
